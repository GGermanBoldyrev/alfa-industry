<nav class="navbar-menu">
    <ul class="flex justify-center items-center h-12 space-x-4">
        ...
        <x-small.button-link class="btn-primary btn-sm" href="{{ route('order') }}">Сделать заказ</x-small.button-link>
    </ul>
</nav>
