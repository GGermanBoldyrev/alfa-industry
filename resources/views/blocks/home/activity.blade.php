<section class="bg-whiteDarker rounded-md px-8 py-12 shadow-xl">
    ...
    <div class="mt-10 space-y-10">
        <div>
            <h6 class="mb-2">Поставка промышленного оборудования</h6>
            <x-highlight-box>
        ...
        <div>
            <h6 class="mb-2">Комплектующие и запасные части</h6>
            <x-highlight-box>
        ...
        <div>
            <h6 class="mb-2">Подбор оборудования и комплектующих</h6>
            <x-highlight-box>
